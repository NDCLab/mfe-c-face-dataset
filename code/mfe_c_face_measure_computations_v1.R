...
main_df <- setNames(data.frame(matrix(ncol = 36, nrow = 0)), c("participant_id", "congAcc", "incongAcc",
...
for (s in 1:nrow(main_df)){
  main_df$hitRate_error_minus_correct[s] <- main_df$error_hitRate[s] - main_df$correct_hitRate[s]
}



### Loading RedCap questionnaire data
redcapDat <- read.csv(file = "/Users/kihossei/Documents/GitHub/mfe_c_face/derivatives/redcap/Memoryforerrorcface_SCRD_2024-06-13_1453.csv")
